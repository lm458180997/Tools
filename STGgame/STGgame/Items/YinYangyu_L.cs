...
namespace stg.Items
{
    public class YinYangyu_L : Item
    {
        ...
        public override void Update(float t)
        {
            ...
            if (player.FlySlow)
            {
                OffRotate = OffRotate + t * 360 > 255 ? 255 : OffRotate + t * 360;
            }
            else
                OffRotate = OffRotate - t * 360 < 180 ? 180 : OffRotate - t * 360;
